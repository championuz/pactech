...
class portfolio extends React.Component {
      ...
      <div className="wrapper main">    
        ...
        <div className="row justify-content-md-center pt-5">
                <div className="text-center col-md-12 col-lg-8">
                  <h2 className="title">Our<span style={{color: "#faaf37"}}> Portfolio</span> </h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="assets/img/lora.jpg" alt="First slide" />
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="assets/img/lora.jpg" alt="Second slide" />
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="assets/img/lora.jpg" alt="Third slide" />
    </div>
  </div>
